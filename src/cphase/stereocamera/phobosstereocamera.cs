...
namespace I3DR.CPhase
{
    ...
    */
    public class CPhobosStereoCamera
    {
        ...
        public static extern IntPtr PhasePhobosStereoCameraCreate(string left_serial, string right_serial, string unique_serial, CameraDeviceType device_type, CameraInterfaceType interface_type);
    }
}