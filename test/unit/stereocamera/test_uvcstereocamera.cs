...
namespace I3DR.PhaseTest
{
    ...
    public class UVCStereoCameraTests
    {
        ...
        public void test_GettingSettingParams()
        {
            ...
            UVCStereoCamera cam = (UVCStereoCamera) StereoCamera.createStereoCamera(device_info);
            ...
            // TODO add get methods to DeimosStereoCamera to check values have been set
